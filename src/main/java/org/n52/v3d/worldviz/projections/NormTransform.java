 ...
 * Basically, both a scaling and a translation operation will be performed. Note
 * that the aspect ratio of the given points will be maintained.
 *
...
public class NormTransform implements CoordinateTransform {
    ...
    public NormTransform(ArrayList<VgPoint> geoPos) {
        if(geoPos.isEmpty() || geoPos == null){
            throw new T3dException("Could not determine NormTransform bounding-box!");
        }
