 ...
 * 
 */
public class FillDataset_DrinkingWater_ruralPop {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.DRINKING_WATER_RURAL_POPULATION_XML;
		String csvFileLocation = RelativePaths.DRINKING_WATER_RURAL_POPULATION_CSV;
		...
		CsvImporter fillDrinkingWater_ruralPop = new CsvImporter(xmlFileLocation, csvFileLocation, csvSeperator, csvHeaders,
				nullValue, zeroValue, numberOfInitLinesToSkip);
		try {
			fillDrinkingWater_ruralPop.fillDatasetEntries();
