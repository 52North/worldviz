...
/**
 * This class generates the Entries part of the 'CountryCodes_simplified_50m.xml'-file.
 ...
 * 
 */
public class FillDataset_CountryCodes_simplified_110m {
	...
	public static void main(String[] args) {
		...
		String xmlFileLocation = RelativePaths.COUNTRY_CODES_SIMPLIFIED_110m_XML;
		String csvFileLocation = RelativePaths.COUNTRY_CODES_SIMPLIFIED_110m_CSV;
		Character csvSeperator = ';';
		String[] csvHeaders = new String[] { "iso_a2", "name_long", "iso_a3" };
		...
		try {
			...
			addGermanName(countryCodesDataset, countryMap, xmlFileLocation);
	...
	private static void addGermanName(DatasetDocument countryCodesDataset,
			Map<String, Country> countryMap, String xmlFileLocation) throws IOException {
		...
		File datasetFile = new File(xmlFileLocation);
		
		countryCodesDataset.save(datasetFile);

		System.out.println(countryCodesDataset.toString());

		System.out.println("Number of unmatched countries: "
				+ listOfFailedCountries.size() + " " + listOfFailedCountries);
	}
