 ...
 * 
 */
public class FillDataset_Sanitation_totalPop {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.SANITATION_TOTAL_POPULATION_XML;
		String csvFileLocation = RelativePaths.SANITATION_TOTAL_POPULATION_CSV;
		...
		CsvImporter fillSanitation_totalPop = new CsvImporter(xmlFileLocation, csvFileLocation, csvSeperator, csvHeaders,
				nullValue, zeroValue, numberOfInitLinesToSkip);
		try {
			fillSanitation_totalPop.fillDatasetEntries();
