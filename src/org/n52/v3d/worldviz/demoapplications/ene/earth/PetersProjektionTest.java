...
public class PetersProjektionTest {
	...
	private static String outputFile = "test/Peters.x3d";
		...
		for (VgIndexedTIN vgIndexedTIN : vgTINs) {
			...
			if (vgIndexedTIN instanceof GmSimpleTINGeometry) {
				...
				for (int i = 0; i < tin.numberOfPoints(); i++) {
					...
					VgPoint newPointBuckmFuller = Wgs84ToPetersTransform
							.transformToPeters(oldPoint);
