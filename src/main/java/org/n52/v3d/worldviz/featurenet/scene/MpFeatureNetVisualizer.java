...
/**
 * Mapper to perform the transformation of a feature-nets to an abstract 3-d connection-map scene. 
 * 
...
public class MpFeatureNetVisualizer extends T3dProcMapper 
{
	...
	/**
	 * sets the style confguration defining the cartographic presentation parameters to be used for 
	 * scene generation.
	 * 
	...
	/**
	 * defines the target coordinate-system. By default, "LON_ELEV_LAT" will be used to set-up a plain lat/lon map in
	 * 3-d space. Alternatively, "SPHERE" can be used to generate a globe-like visualization.
	 * 
