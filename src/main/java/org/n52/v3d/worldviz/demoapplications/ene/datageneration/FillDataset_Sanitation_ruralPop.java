 ...
 * 
 */
public class FillDataset_Sanitation_ruralPop {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.SANITATION_RURAL_POPULATION_XML;
		String csvFileLocation = RelativePaths.SANITATION_RURAL_POPULATION_CSV;
		...
		CsvImporter fillSanitation_ruralPop = new CsvImporter(xmlFileLocation, csvFileLocation, csvSeperator, csvHeaders,
				nullValue, zeroValue, numberOfInitLinesToSkip);
		try {
			fillSanitation_ruralPop.fillDatasetEntries();
