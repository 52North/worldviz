...
public abstract class VsAbstractWorldScene extends VsScene {
	...
	// x3d as standard; VRML und KML möglich, wobei KML weniger Funktionen
	// unterstützt
	// macht KML dann überhaupt Sinn
	// wobei man auch in SketchUp Objekte wie Kugeln, Boxen nachbasten kann und
	// die dann benutzen kann!
	...
	// TODO hier in der abstract generateScene
	@Override
	public final Object generateScene() {

		// TODO hier jetzt die Szenenbeschreibung erstellen
		// sprich die allgemeinen Szenenobjekt-unabhängigen Elemente der Szene
		// (wie Metadaten)
		// dann die Szenenobjekte von den jeweiligen Kindklassen anfügen
		// dann abschließend die Szenenbeschreibung abschließen.
	...
	private void startSceneDescription() {
		// TODO start the scene description
	...
	private void endSceneDescription() {
		// TODO end the scene description
		switch (outputFormat) {
		case X3D:
	...
	private void startX3dDescription(boolean asX3DOM) {
		...
		try {
			...
			// TODO hier die entsprechenden anfänglichen Scene-Parameter
			// ergänzen!
			wl("  <Scene>");
