 ...
 * 
 */
public class FillDataset_Sanitation_urbanPop {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.SANITATION_URBAN_POPULATION_XML;
		String csvFileLocation = RelativePaths.SANITATION_URBAN_POPULATION_CSV;
		...
		CsvImporter fillSanitation_urbanPop = new CsvImporter(xmlFileLocation, csvFileLocation, csvSeperator, csvHeaders,
				nullValue, zeroValue, numberOfInitLinesToSkip);
		try {
			fillSanitation_urbanPop.fillDatasetEntries();
