 ...
 * 
 */
public class FillDataset_IndiaStateNames {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.INDIA_STATE_NAMES_XML;
		String csvFileLocation = RelativePaths.INDIA_STATE_NAMES_CSV;
		...
		CsvImporter fillIndiaStates = new CsvImporter(xmlFileLocation,
				csvFileLocation, csvSeperator, csvHeaders, nullValue,
				zeroValue, numberOfInitLinesToSkip);
		try {
			fillIndiaStates.fillDatasetEntries();
