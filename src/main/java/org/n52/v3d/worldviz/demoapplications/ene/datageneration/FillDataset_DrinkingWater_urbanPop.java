 ...
 * 
 */
public class FillDataset_DrinkingWater_urbanPop {

	public static void main(String[] args) {
		String xmlFileLocation = RelativePaths.DRINKING_WATER_URBAN_POPULATION_XML;
		String csvFileLocation = RelativePaths.DRINKING_WATER_URBAN_POPULATION_CSV;
		...
		CsvImporter fillDrinkingWater_urbanPop = new CsvImporter(xmlFileLocation, csvFileLocation, csvSeperator, csvHeaders,
				nullValue, zeroValue, numberOfInitLinesToSkip);
		try {
			fillDrinkingWater_urbanPop.fillDatasetEntries();
