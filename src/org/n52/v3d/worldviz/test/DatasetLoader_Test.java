...
public class DatasetLoader_Test {
	...
	public void testBitmap() {
		...
		try {
			...
			assertTrue(attributeNames[0].equals("File name"));
			assertTrue(attributeNames[1].equals("Image size"));

			Object fileNameValue = bitmapFeature
					.getAttributeValue(attributeNames[0]);
	...
	public void testPoint() {
		...
		try {
			...
			assertTrue(attributeNames[1].equals("Place"));
			assertTrue(attributeNames[2].equals("Year"));
			assertTrue(attributeNames[3].equals("INES scale level"));
	...
	public void testCountryCode() {
		...
		try {
			...
			// has no unit and thus no code and titles
			assertTrue(unit.getCode().equals("Gg/a"));
			assertTrue(unit.getTitles()[0].equals("Gigagrams per year"));
			...
			assertTrue(attributeNames[0].equals("2000"));
			assertTrue(attributeNames[1].equals("2001"));
			assertTrue(attributeNames[2].equals("2002"));
			assertTrue(attributeNames[3].equals("2003"));

			Object year2001Value = countryCodeFeature
					.getAttributeValue(attributeNames[1]);
			assertTrue(year2001Value.toString().equals("0"));
